# Death rate from drought - Data package

This data package contains the data that powers the chart ["Death rate from drought"](https://ourworldindata.org/explorers/natural-disasters?Disaster+Type=Droughts&Impact=Deaths&Timespan=Annual&Per+capita=true&country=~OWID_WRL) on the Our World in Data website.
...
#### Full citation
EM-DAT, CRED / UCLouvain – processed by Our World in Data. “Death rates from drought” [dataset]. EM-DAT, CRED / UCLouvain [original data].
