# Total number of people affected by drought per 100,000 - Data package

This data package contains the data that powers the chart ["Total number of people affected by drought per 100,000"](https://ourworldindata.org/explorers/natural-disasters?Disaster+Type=Droughts&Impact=Total+affected&Timespan=Annual&Per+capita=true&country=~OWID_WRL) on the Our World in Data website.
...
#### Full citation
EM-DAT, CRED / UCLouvain – processed by Our World in Data. “Total number of people affected by drought per 100,000” [dataset]. EM-DAT, CRED / UCLouvain [original data].
