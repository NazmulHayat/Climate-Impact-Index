# Death rate from floods - Data package

This data package contains the data that powers the chart ["Death rate from floods"](https://ourworldindata.org/explorers/natural-disasters?Disaster+Type=Floods&Impact=Deaths&Timespan=Annual&Per+capita=true&country=~OWID_WRL) on the Our World in Data website.
...
#### Full citation
EM-DAT, CRED / UCLouvain – processed by Our World in Data. “Death rates from floods” [dataset]. EM-DAT, CRED / UCLouvain [original data].
