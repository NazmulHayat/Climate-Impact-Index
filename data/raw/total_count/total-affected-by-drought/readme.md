# Total number of people affected by drought - Data package

This data package contains the data that powers the chart ["Total number of people affected by drought"](https://ourworldindata.org/explorers/natural-disasters?Disaster+Type=Droughts&Impact=Total+affected&Timespan=Annual&Per+capita=false&country=~OWID_WRL) on the Our World in Data website.
...
#### Full citation
EM-DAT, CRED / UCLouvain – processed by Our World in Data. “Number of total people affected by drought” [dataset]. EM-DAT, CRED / UCLouvain [original data].
